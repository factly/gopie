...
select d.id, d.name, d.description, d.created_at, d.updated_at, d.row_count, d.alias, d.created_by, d.updated_by, d.size, d.file_path, d.columns, d.org_id, d.custom_prompt from datasets d join project_datasets pd on d.id = pd.dataset_id where pd.project_id = $1
`
