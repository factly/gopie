...
PREFETCH_API_URL = settings.HUNTING_API_PREFETCH_ENDPOINT + "/api/v1/prefetch/"
PROFILE_API_URL = settings.HUNTING_API_DESCRIPTION_ENDPOINT + "/api/v1/profile/description/"
