...
var _ objectstore.FileIterator = &blobIterator{}

func NewIterator(ctx context.Context, bucket *blob.Bucket, opts BlobOptions, logger Logger) (objectstore.FileIterator, error) {
	opts.validate()
...
func (it *blobIterator) Size(unit objectstore.ProgressUnit) (int64, bool) {
...
func retry(logger Logger, maxRetries int, delay time.Duration, fn func() error) error {
...
func (it *prefetchdIterator) Size(unit objectstore.ProgressUnit) (int64, bool) {
