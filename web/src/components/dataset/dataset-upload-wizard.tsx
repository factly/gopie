...
import {
  CsvValidationUppy,
  FileValidationUppyRef,
} from "@/components/dataset/csv-validation-uppy";
          ...
          <div className="space-y-8">
            ...
            <div className="bg-card border p-6">
              ...
              {isGeneratingDescriptions && (
                <Alert className="mb-4 bg-muted/50 border-muted-foreground/20">
                  ...
                  <AlertDescription>
                    AI is analyzing your data to generate helpful column
                    descriptions. This may take a few moments...
                  </AlertDescription>
                </Alert>
              )}
              <CsvValidationUppy
            ...
            <div className="bg-card border p-6">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Import a dataset directly from a publicly accessible URL.
                Supports CSV, JSON, and other data formats.
              </p>
              <UrlUploader
                projectId={projectId}
                onUploadSuccess={handleFileValidated}
